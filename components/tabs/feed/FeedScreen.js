  ...
  loadPostComment = () => {
    axios
      ...
      .then((response) => {
        ...
        this.setState({
          listPostComment: this.state.listPostComment.concat(
  ...
  loadPostLike = () => {
    axios
      ...
      .then((response) => {
        ...
        this.setState({
          listPostLike: this.state.listPostLike.concat(
            response.data.success.data,
          ),
          isLoading: false,
          isLoadingList: false,
        ...
        <View style={styles.background}>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={this.openPostLike}>
              {this.state.likePost ? (
                <ImageBackground
                  source={IMAGE.TAB_ACTIVE_BG}
