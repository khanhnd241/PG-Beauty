        ...
        <ScrollView ref="_scrollView" style={styles.background}>
          ...
          <View style={styles.content}>
            <Text style={styles.tag}>
              {STRING.TAG} {this.state.category.name}
            </Text>
            <View style={styles.title}>
              <View style={{flex: 6}}>
                <Text style={styles.title_text}>
                  {this.state.product.full_name}
                </Text>
              </View>
              {this.state.sale !== 0 ? (
                <View style={{flex: 1}}>
            ...
            <View style={styles.title}>
              ...
              {this.state.sale !== 0 ? (
                <Text style={styles.old_price}>
                  {this.format(parseInt(this.state.product.base_price))}{' '}
                  {STRING.CURRENCY}
                </Text>
              ) : null}
            </View>
            ...
            {this.state.ammount == '0' ? (
              ...
              <View style={{flexDirection: 'row'}}>
                <View style={{flex: 3}}>
                  <Text style={{fontSize: 14, fontFamily: STRING.FONT_NORMAL}}>
                    {STRING.AMOUNT}{' '}
                    <Text style={{color: COLOR.GREEN}}>
                      ({STRING.STILL} {this.state.ammount})
                    </Text>{' '}
                  </Text>
                </View>
                <View
          ...
          <View style={styles.content}>
            ...
            <HTMLView value={this.state.product.description} />
          </View>
          <View
            style={{
              backgroundColor: COLOR.GRAY,
          ...
          {/* Thông số */}
          <View style={styles.content}>
            <Text style={styles.made_in_title}>
            ...
            <View style={styles.made_in}>
              ...
              <View style={{flex: 2}}>
                <Text style={styles.made_in_text}>
