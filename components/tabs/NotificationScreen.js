...
function ItemPromotion({title, content, timeLine, index}) {
  ...
  return (
    <View>
      ...
      <View
        style={{borderTopWidth: 0.5, borderColor: COLOR.LINE, marginBottom: 5}}
      />
    </View>
  );
}
      ...
      <SafeAreaView style={styles.screen}>
        ...
        <View style={styles.background}>
          ...
          <View style={styles.option}>
            <TouchableOpacity
              onPress={this.openPromotion}
              style={[styles.tab, {backgroundColor: this.state.promotionBG}]}>
              <Text style={{fontSize: 14, color: this.state.promotionText}}>
                {STRING.PROMOTION}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={this.openForYou}
              style={[styles.tab, {backgroundColor: this.state.forYouBG}]}>
              <Text style={{fontSize: 14, color: this.state.forYouText}}>
                {STRING.FOR_YOU}
              </Text>
            </TouchableOpacity>
          </View>
