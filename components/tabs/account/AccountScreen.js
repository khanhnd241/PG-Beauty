      ...
      <SafeAreaView style={styles.screen}>
        ...
        {this.state.isLogin ? (
          <View style={styles.container}>
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{flex: 8, alignItems: 'center'}}>
                <ImageBackground
                  style={styles.bg_avatar}
                  source={IMAGE.BG_AVATAR}>
                  {this.state.man ? (
              ...
              <TouchableOpacity
                style={{flex: 1, alignItems: 'center', marginTop: 16}}>
                <SvgUri svgXmlData={EDIT} />
              </TouchableOpacity>
            </View>
            <View style={{alignItems: 'center', marginTop: 10}}>
              <Text style={{color: COLOR.TEXTBODY, fontSize: 14, padding: 5}}>
                {this.state.name}
              </Text>
              <Text
                style={{color: COLOR.DESCRIPTION, fontSize: 14, padding: 5}}>
                {this.state.phone}
              </Text>
            </View>
            ...
            <TouchableOpacity
              ...
              <View style={styles.item_description}></View>
              <View style={styles.next}>
                <SvgUri svgXmlData={NEXT} />
              </View>
            </TouchableOpacity>
          ...
          <View style={styles.container}>
            ...
            <View
              style={{height: 5, backgroundColor: COLOR.GRAY, marginTop: 30}}
            />
            {/* Cài đặt */}
            {/* <TouchableOpacity style={styles.item}>
                                <View style={styles.item_icon}>
